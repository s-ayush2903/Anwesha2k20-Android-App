...
public class AboutFragment extends Fragment implements View.OnClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Glide.with(context).load("https://instagram.fdel27-1.fna.fbcdn.net/vp/7fcc78773c9364271f08\bbc9ae7a7a41/5E7C8575/t51.2885-19/s150x150/70891287_314435436086146_8847141092227809280_n.jpg?_nc_ht=instagram.fdel27-1.fna.fbcdn.net").placeholder(R.mipmap.anwesha_icon_round).into(image6);
